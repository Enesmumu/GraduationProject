package com.school.graduationdesign.ChooseSeat;
...
import com.school.graduationdesign.Activity.Confirm;
 ...
 * @author captain_miao
 */
public class SelectMovieSeatActivity extends Activity implements OnTouchListener,View.OnClickListener {
    private Button seat_queren;
    private ImageView seat_fanhui;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        seatTableView = (SeatTableView) findViewById(R.id.seat_view);
        rowView = (LinearLayout) findViewById(R.id.seat_raw);

        seat_queren = (Button) findViewById(R.id.seat_queren);
        seat_fanhui = (ImageView) findViewById(R.id.seat_fanhui);

        seat_fanhui.setOnClickListener(this);
        seat_queren.setOnClickListener(this);
...
//        rowView.startAnimation(alpha);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.seat_queren:
                AlertDialog.Builder builder = new AlertDialog.Builder(SelectMovieSeatActivity.this);
                ...
                dialog.setButton(DialogInterface.BUTTON_POSITIVE, "确认", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(SelectMovieSeatActivity.this, Confirm.class);
